...
func genSQL(ctx *context.Context, counter bool, tag, keyword string, to string, offset, limit int) (string, []any) {
	...
	if to != "" {
		sql += " and (`to` like ? ) and create_time >= NOW() - INTERVAL 1 HOUR"
